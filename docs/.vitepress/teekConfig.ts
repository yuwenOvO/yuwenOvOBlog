...
export const teekConfig = defineTeekConfig({
  ...
  loading: false, // 是否开启页面加载 Loading 动画
  ...
  codeBlock: {
    ...
    collapseHeight: 1200, // 超出高度后自动折叠，设置 true 则默认折叠，false 则默认不折叠
  ...
  // bodyBgImg: {
  //   imgSrc: ["/blog/bg1.webp", "/blog/bg2.webp"], // body 背景图片链接。单张图片 string | 多张图片 string[], 多张图片时每隔 imgInterval 秒换一张
  //   imgOpacity: 1, // body 背景图透明度，选值 0.1 ~ 1.0
  //   imgInterval: 5000, //  body 当多张背景图时（imgSrc 为数组），设置切换时间，单位：毫秒
  ...
  author: {
    name: "yuwenOvO", // 作者名称
    link: "https://github.com/yuwenOvO", // 点击作者名称后跳转的链接
  },
  // 公告配置
  notice: {
  ...
  banner: {
    ...
    name: "yuwenOvO", // Banner 标题，默认读取 vitepress 的 title 属性
    bgStyle: "fullImg", // Banner 背景风格：pure 为纯色背景，partImg 为局部图片背景，fullImg 为全屏图片背景
    pureBgColor: "#28282d", // Banner 背景色，bgStyle 为 pure 时生效
    imgSrc: ["/banner/bg_01.webp", "/banner/bg_02.webp"], // Banner 图片链接。bgStyle 为 partImg 或 fullImg 时生效
  ...
  docAnalysis: {
    ...
    // 自定义额外信息
    appendInfo: [{ key: "index", label: "站点作者", value: "yuwenOvO" }],
  },
  ...
  articleBottomTip: (frontmatter) => {
    ...
    return {
      ...
      // title: "声明", // 可选
      text: `<p>作者：${author}</p>
             <p style="margin-bottom: 0">链接：<a href="${decodeURIComponent(
               url
