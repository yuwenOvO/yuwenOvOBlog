...
## Linux 系统安装 Docker{#linux-install}

### 设置 Docker 的仓库{#docker-repo}
...
{
  "registry-mirrors": [
    "https://docker-0.unsee.tech" # 现在很多国内镜像源都不可用了，这个暂时还能用
  ]
}
```
