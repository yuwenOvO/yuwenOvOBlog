...
::: tip
注意：最新的 MinIO 镜像 移除了大部分的 webUI 功能，建议使用 `minio/minio:RELEASE.2025-04-22T22-12-26Z` 版本。
:::
...
- `-e "MINIO_ACCESS_KEY=xxxx"`：设置 MinIO 的 Username
- `-e "MINIO_SECRET_KEY=xxxx"`：设置 MinIO 的 Password
