---
title: Prisma 异常过滤器
date: 2025-11-05 11:42:56
permalink: /nestjs/prismaExceptionFilter
coverImg: /banner/bg_01.webp
categories:
  - nest
tags:
  - nest
...
import { PrismaFilter } from "./common/filters/prisma-exception-filter"; // [!code ++]

async function bootstrap() {
  const app = await NestFactory.create(AppModule);
  app.useGlobalFilters(new PrismaFilter()); // [!code ++]
