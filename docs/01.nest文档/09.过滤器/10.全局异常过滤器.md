---
title: 全局异常过滤器
date: 2025-11-05 11:35:17
permalink: /nestjs/globalExceptionFilter
categories:
  - nest
tags:
  - nest
...
import { GlobalFilter } from "./common/filters/global.filter"; // [!code ++]
async function bootstrap() {
  const app = await NestFactory.create(AppModule);
  app.useGlobalFilters(new GlobalFilter()); // [!code ++]
